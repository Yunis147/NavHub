...
def generate_launch_description():
    ...
    # Path to our filter config — resolved from the installed nav2 package share dir
    # so it works on any machine (Pi or laptop) regardless of checkout location.
    filter_params = os.path.join(get_package_share_directory('nav2'), 'params', 'laser_filter.yaml')
